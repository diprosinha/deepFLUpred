"""Load bundled or user-supplied FluMAPPER model bundles."""
...
class ModelStore:
    ...
    def load_segment_model(self) -> dict:
        ...
        if self.segment_model:
            ...
            resource = files("flumapper") / "resources/models/segment_model/model.joblib"
    ...
    def load_subtype(self, segment: str) -> dict:
        ...
        if self.subtype_model_dir:
            ...
            resource = files("flumapper") / f"resources/models/subtype_models/{segment}/model.joblib"
    ...
    def load_pathogenicity(self, host: str) -> dict:
        ...
        if self.pathogenicity_model_dir:
            ...
            resource = files("flumapper") / f"resources/models/pathogenicity_models/{host}/model.joblib"
            bundle = self._load_resource(resource)
    ...
    def verify_bundled_models() -> dict[str, bool]:
        ...
        model_root = files("flumapper") / "resources/models"
